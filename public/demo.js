demo = {
    ...
    initDocumentationCharts: function () {
        ...
        var dailySalesChart = document.querySelector("#dailySalesChart");
    ...
    initCharts: function () {
        ...
        var roundedLineChart = document.querySelector("#roundedLineChart");
        ...
        var straightLinesChart = document.querySelector("#straightLinesChart");

        if (straightLinesChart) {
        ...
        var colouredRoundedLineChart = document.querySelector("#colouredRoundedLineChart");

        if (colouredRoundedLineChart) {
        ...
        var colouredBarsChart = document.querySelector("#colouredBarsChart");

        if (colouredBarsChart) {
        ...
        var chartPreferences = document.querySelector("#chartPreferences");
